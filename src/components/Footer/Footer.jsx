...
function Footer() {
  return (
    <div className="w-full h-screen flex gap-5 p-20 bg-zinc-900 text-[#F1F1F1] rounded-t-2xl">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[7vw] uppercase font-semibold font-['Founders Grotesk X-Cond'] tracking-tighter leading-none -mb-5">
            Eye-
          </h1>
          <h1 className="text-[7vw] uppercase font-semibold font-['Founders Grotesk X-Cond'] tracking-tighter leading-none -mb-5">
            Opening
      ...
      <div className="w-1/2">
        ...
        <div className="w-full h-[70vh] mt-10 flex gap-5">
          <div className="w-1/2 h-full">
            <div className="w-full">
              <h3 className="mb-5">S:</h3>
              <div className="flex flex-col gap-1">
                {["Instagram", "Behance", "Facebook", "LinkedIn"].map(
                  (item, index) => (
                    <div key={index}>
                      <a href="#" className="border-b-2 border-zinc-100 py-1">
                        {item}
                      </a>
                    </div>
                  )
              ...
              <div className="w-full mt-10">
                <h3 className="mb-4">L:</h3>
                <div className="flex flex-col gap-4">
                  <div>
                    <p className="w-36 border-b-2 border-zinc-100 py-1">
                      202-1965 W 4th Ave
                    </p>
                    <p className="w-36 border-b-2 border-zinc-100 py-1">
                      Vancouver, Canada
              ...
              <div className="w-full mt-10">
                <h3 className="mb-5">E:</h3>
                <h3 className="border-b-2 w-32 border-zinc-100 py-1">
                  hello@ochi.design
                </h3>
              </div>
            </div>
